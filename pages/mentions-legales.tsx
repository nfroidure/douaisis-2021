...
const Page = () => (
  <Layout title="Mentions légales">
    <ContentBlock>
      ...
      <Paragraph>
        Le site {DOMAIN_NAME} est édité par "{ORGANISATION_LEGAL_NAME}",
        personne morale sis 12 rue Lydéric 59000 Lille. Le directeur de
        publication est Nicolas FROIDURE.
      </Paragraph>
      ...
      <Paragraph>
        Merci à nos prestaires pour la création de ce site :
      </Paragraph>
      <UnorderedList>
        <ListItem>
          charte graphique et logo&nbsp;: Nosy - Florian Beulaguet
        </ListItem>
